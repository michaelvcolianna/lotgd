 ...
 * Conditional include
 *
 * Only doing the real include now if running a new process. This will be in
 * place until the old code has been reworked and moved out of the public
 * directory.
 */
$new_processes = [
    'error',
...
if(in_array($script, $new_processes))
{
